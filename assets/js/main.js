...
if(form){
  form.addEventListener('submit',e=>{
    ...
    alert(`Thanks for reaching out, ${data.name||'friend'}! We've received your message and will get back to you at ${data.email||'your email address'} as soon as we can.`);
    form.reset();
  });
}
